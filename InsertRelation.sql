...
insert into book values('4','The Lost Symbol','Famed Harvard symbologist Robert Langdon answers an unexpected summons','Dan Brown',509,NULL,NULL);
insert into book values('5','Angels and demons','Robert Langdons journey ','Dan Brown',529,NULL,NULL);
insert into book values('6','The DA Vinci Code','Robert Langdons journey ','Dan Brown',559,NULL,NULL);
...
insert into author values('5', 'Dan Brown', null, null, 'Hi, I am Dan Brown');
...
insert into book_reader values('2', 'tanmay');
insert into book_reader values('3', 'tanmay');
insert into book_reader values('4', 'tanmay');
insert into book_reader values('1', 'tanmay');
insert into book_reader values('5', 'tanmay');
...
insert into already_read values('5','tanmay');
